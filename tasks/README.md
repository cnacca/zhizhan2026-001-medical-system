...
- 下一步进入 T2 客服协同闭环第一增量：先补红灯检查，再围绕订单消息、生产消息待审、资料缺失提示、AI 翻译草稿确认和客服通知联动做最小可验收闭环。
