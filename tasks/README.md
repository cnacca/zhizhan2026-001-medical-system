...
- 2026-08-18：医生端英文界面已按 D-197 完整收口。共享登录页按用户确认保持中文，进入医生端后才应用中文／`EN` 切换。PR #32/#33/#35 已合并 `dev`，PR #34/#36 已合并 `main`，最终正式版本 `f406d105166c0b3bc6c266fead7b80c895b4d470`，自动部署 #32049802365 成功通过后端 351 项测试、release gates、镜像校验、备份、部署、健康检查及公网探针。正式站只读浏览器已验证 7 个主页及下单子流程，最终复验确认中文登录页、英文标签页、`A/EN` 消息标记、`YYYY-MM-DD` 日期框和正畸产品英文映射；原始业务数据保留原文。未写正式业务数据，Task 8 保持 `NOT_READY`。
