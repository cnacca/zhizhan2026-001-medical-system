...
- 2026-08-17：医生端英文界面已按 D-197 发布正式站。PR #27/#28 已合并，正式版本 `78c0955b35f519f77bf28b107e8ae5a1b138cfd6`，自动部署运行 #32033871635 成功通过后端全量测试、release gates、镜像校验、备份、部署、健康检查及公网探针。线上实际医生端 JS/CSS 包已核对英文关键文案、语言记忆键和可切换标签；当前浏览器读取通道超时，未记录登录后真实点击。本轮未写正式业务数据，未改后端、权限或脱敏，Task 8 保持 `NOT_READY`。
