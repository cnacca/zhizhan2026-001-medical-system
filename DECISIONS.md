...
状态：用户已于 2026-08-17 明确要求医生端英文界面；当前实现已在本地完成并通过专项检查和前端生产构建，尚未合并或部署。
...
影响：`docs/acceptance/phase-two-scope-baseline-20260726.md` 中“多语言不在范围内”保留为当时基线，但被本决策对“医生端界面”的范围局部取代。客服、生产、管理三端，英文操作手册、海外时区和海外业务规则仍不在本次范围。本地通过不等于已上线，Task 8 继续保持 `NOT_READY`。
