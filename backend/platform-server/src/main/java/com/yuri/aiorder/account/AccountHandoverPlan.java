...
public final class AccountHandoverPlan {
    ...
    public static final Set<String> HISTORICAL_COLUMNS = Set.of(
            ...
            "order_box_assignment.assigned_by_user_id",
            "order_box_assignment.released_by_user_id",
            "order_business_audit.actor_user_id",
            "order_delivery_plan.manual_override_by",
            "order_logistics.receipt_confirmed_by",
            "order_supplement_file.uploaded_by_user_id",
            "order_supplement_file.approved_by_user_id",
