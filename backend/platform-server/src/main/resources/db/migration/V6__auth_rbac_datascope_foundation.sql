...
SELECT '本地测试诊所', 'Local Doctor', 'ACTIVE'
WHERE NOT EXISTS (
    SELECT 1 FROM clinic WHERE clinic_name = '本地测试诊所'
);
...
VALUES
    (8001, 'admin', 'pbkdf2_sha256$120000$DUAy+aGwMHsgrpHbiuoykA==$i9YpQ8n/TBZRGGVg/em/HfH1++x7A8Ub72U5LUc9tFA=', '本地管理员', NULL, 'ADMIN', 'ACTIVE'),
    (8002, 'cs', 'pbkdf2_sha256$120000$3ODuOW+t81iLLLqv6izqxQ==$/DRBFRUKmQE4x9w6UX5USFGvAMJp/mXpVJ6Xz28nWIs=', '本地客服', NULL, 'CS', 'ACTIVE'),
    (9601, 'worker', 'pbkdf2_sha256$120000$Rs2yTLCiwZDCen8NRGRmNg==$bi39dlchyH/bKNosCbDYs+ztJ8xAnofk4OWX2y782cs=', '本地生产员工', NULL, 'WORKER', 'ACTIVE'),
    (9701, 'doctor', 'pbkdf2_sha256$120000$lqdaAx81oEF+8JI6/kCdpw==$SrDw2FjWST5U6soPUDErfEOXgnvnb4EW+ApfsGIT9hY=', '本地医生', (SELECT clinic_id FROM clinic WHERE clinic_name = '本地测试诊所'), 'DOCTOR', 'ACTIVE');
