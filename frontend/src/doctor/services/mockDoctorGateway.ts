...
const account: DoctorAccount = {
  ...
  members: [
    { member_id: 'MB-1', display_name: '陈医生', email: 'doctor@mingyue.example', roles: ['CLINIC_ADMIN', 'DOCTOR'], status: 'ACTIVE', billing_permission: 'FINANCIAL_ACTION', logistics_permission: 'RECEIPT' },
    { member_id: 'MB-2', display_name: '林医生', email: 'lin@mingyue.example', roles: ['DOCTOR'], status: 'ACTIVE', billing_permission: 'VIEW', logistics_permission: 'RECEIPT' },
    { member_id: 'MB-3', display_name: '张前台', email: 'frontdesk@mingyue.example', roles: ['RECEPTION'], status: 'ACTIVE', billing_permission: 'VIEW', logistics_permission: 'VIEW' },
    { member_id: 'MB-4', display_name: '周护士', email: 'nurse@mingyue.example', roles: ['NURSE'], status: 'PENDING_ACTIVATION', billing_permission: 'NONE', logistics_permission: 'VIEW' }
  ]
}
