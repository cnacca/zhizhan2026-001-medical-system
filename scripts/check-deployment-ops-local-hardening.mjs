...
if (acceptance.active_goal !== 'GOAL-020') {
  failures.push(`acceptance.json active_goal expected GOAL-020, got ${acceptance.active_goal}`)
}
if (acceptance.active_goal_file !== 'goals/GOAL-020-deployment-ops-local-hardening-20260707.md') {
  failures.push(`acceptance.json active_goal_file expected GOAL-020 file, got ${acceptance.active_goal_file}`)
}
if (acceptance.active_task_file !== 'tasks/TASK-021-deployment-ops-local-hardening-20260707.md') {
  failures.push(`acceptance.json active_task_file expected TASK-021 file, got ${acceptance.active_task_file}`)
}
