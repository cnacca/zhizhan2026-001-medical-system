...
if (acceptance.active_goal !== 'GOAL-017') {
  failures.push(`acceptance.json active_goal expected GOAL-017, got ${acceptance.active_goal}`)
}
if (acceptance.active_goal_file !== 'goals/GOAL-017-frontend-productization-closure-20260707.md') {
  failures.push(`acceptance.json active_goal_file expected GOAL-017 file, got ${acceptance.active_goal_file}`)
}
if (acceptance.active_task_file !== 'tasks/TASK-018-frontend-productization-closure-20260707.md') {
  failures.push(`acceptance.json active_task_file expected TASK-018 file, got ${acceptance.active_task_file}`)
}
