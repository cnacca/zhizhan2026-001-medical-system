...
for (const text of [
  ...
  "document.title = language === 'EN' ? 'PrecisionDental Lab — Doctor Portal'",
  "正畸产品: 'Orthodontic Appliance'",
  "review: 'Records Review'",
  "ORDER: 'Order Notification'",
  "'医生已确认收货': 'Receipt Confirmed by Doctor'",
  'publicProgressLabel(item)',
  'publicOrderMessage(selectedOrder.public_message)',
  'notificationTitle(item)',
  'notificationSummary(item)',
  'processConfirmationName(confirmation)',
  'billItemName(item)',
  'logisticsEventLabel(event.label)',
  "t('A/文', 'A/EN')",
