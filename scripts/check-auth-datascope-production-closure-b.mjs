...
if (acceptance.active_goal !== 'GOAL-016') {
  failures.push(`acceptance.json active_goal expected GOAL-016, got ${acceptance.active_goal}`)
}
if (acceptance.active_goal_file !== 'goals/GOAL-016-auth-datascope-production-closure-b-20260707.md') {
  failures.push(`acceptance.json active_goal_file expected GOAL-016 file, got ${acceptance.active_goal_file}`)
}
