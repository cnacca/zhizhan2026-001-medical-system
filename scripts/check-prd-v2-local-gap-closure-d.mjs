...
if (acceptance.active_goal !== 'GOAL-010') {
  failures.push(`acceptance.json active_goal expected GOAL-010, got ${acceptance.active_goal}`)
}
if (acceptance.active_goal_file !== 'goals/GOAL-010-prd-v2-local-gap-closure-d-20260707.md') {
  failures.push(`acceptance.json active_goal_file expected GOAL-010 file, got ${acceptance.active_goal_file}`)
}
