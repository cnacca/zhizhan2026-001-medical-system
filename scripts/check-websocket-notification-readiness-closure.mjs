...
if (acceptance.active_goal !== 'GOAL-014') {
  failures.push(`acceptance.json active_goal expected GOAL-014, got ${acceptance.active_goal}`)
}
if (acceptance.active_goal_file !== 'goals/GOAL-014-websocket-notification-readiness-closure-20260707.md') {
  failures.push(`acceptance.json active_goal_file expected GOAL-014 file, got ${acceptance.active_goal_file}`)
}
