...
if (acceptance.active_goal !== 'GOAL-019') {
  failures.push(`acceptance.json active_goal expected GOAL-019, got ${acceptance.active_goal}`)
}
if (acceptance.active_goal_file !== 'goals/GOAL-019-ai-production-governance-local-hardening-20260707.md') {
  failures.push(`acceptance.json active_goal_file expected GOAL-019 file, got ${acceptance.active_goal_file}`)
}
if (acceptance.active_task_file !== 'tasks/TASK-020-ai-production-governance-local-hardening-20260707.md') {
  failures.push(`acceptance.json active_task_file expected TASK-020 file, got ${acceptance.active_task_file}`)
}
