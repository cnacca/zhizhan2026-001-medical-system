...
VALUES
 ('ORD20260718-1001',@clinic_id,@doctor_id,@p1,8002,'IMPLANT_RESTORATION',168000,'CNY','PRODUCT',JSON_OBJECT('patient_name','张先生','patient_code','A026','product_name','种植冠','tags',JSON_ARRAY('VIP','种植'),'tooth','14','material','氧化锆·钛基台','shade','A2','due_date','2026-07-24'),'IN_DESIGN','DESIGNING','2026-07-15 09:20:00','2026-07-18 09:10:00'),
 ...
 ('ORD20260717-1003',@clinic_id,@doctor_id,@p3,8002,'FIXED_CROWN',98000,'CNY','PRODUCT',JSON_OBJECT('patient_name','王先生','patient_code','B008','product_name','常规牙冠','tags',JSON_ARRAY('新患者'),'tooth','11','material','氧化锆','shade','A2','due_date','2026-07-22'),'IN_QC','QC','2026-07-13 11:35:00','2026-07-18 10:35:00'),
 ('ORD20260712-1004',@clinic_id,@doctor_id,@p4,8002,'FIXED_BRIDGE',286000,'CNY','PRODUCT',JSON_OBJECT('patient_name','赵女士','patient_code','B012','product_name','固定桥','tags',JSON_ARRAY(),'tooth','35-37','material','全瓷','shade','A2','due_date','2026-07-20'),'QC_PASSED','PENDING_SHIP','2026-07-12 10:05:00','2026-07-18 13:20:00'),
