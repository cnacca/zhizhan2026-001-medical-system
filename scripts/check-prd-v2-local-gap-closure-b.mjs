...
if (acceptance.active_goal !== 'GOAL-008') {
  failures.push(`acceptance.json active_goal expected GOAL-008, got ${acceptance.active_goal}`)
}
if (acceptance.active_goal_file !== 'goals/GOAL-008-prd-v2-local-gap-closure-b-20260707.md') {
  failures.push(`acceptance.json active_goal_file expected GOAL-008 file, got ${acceptance.active_goal_file}`)
}
